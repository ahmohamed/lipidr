...
```{r}
plot_mva(mvaresults, color_by="Class", top.n=30)
```
...
For more complex experimental designs, where one might deal with factor adjustment or interactions, it is recommended to use `de_design` function. Users can either provide a design matrix, or a formula to create one.
