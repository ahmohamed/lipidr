...
# Download datasets
Datasets can be easily downloaded and parsed into `SkylineExperiment` object
...
```
We can see mild separation between benign and cancer samples, but not between cancer and metastasis. We can also spot 2 outlier samples that we may want to consider checking closely. The low variance explained by `PC1` and `PC2`
